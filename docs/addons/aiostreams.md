...
5. Paste the manifest URL into the box and click **Install**
6. Navigate to **Installed** (top left) and drag the AIOLists addon to the top of your addon list
7. In the **CATALOGS** section below **MY ADDONS**, click the refresh icon to populate your catalogs
8. Reorder catalogs by dragging them or using the arrow icons

::: warning
If you do not install AIOLists, or forget to click the refresh icon, your Stremio homescreen will be blank
:::
